...
export const COMPONENT_IMPORTS: Record<string, React.ComponentType<VesselComponentProps>> = {
  ...
  "apparatus-fblf": dynamic(() => import("../../../../packages/core/src/components/static-image"), { ssr: false }),
  ...
  "apparatus-ll": dynamic(() => import("../../../../packages/core/src/components/static-image"), { ssr: false }),
  ...
  "apparatus-hoqnl": dynamic(() => import("../../../../packages/core/src/components/static-image"), { ssr: false }),
