...
import { meta as gimbalStream } from "@abyss-ui/core/components/gimbal-stream/meta";
import { meta as gravityCursor } from "@abyss-ui/core/components/gravity-cursor/meta";
import { meta as hoverMediaStream } from "@abyss-ui/core/components/hover-media-stream/meta";
import { meta as japparii } from "@abyss-ui/core/components/japparii/meta";
import { meta as kineticPortal } from "@abyss-ui/core/components/kinetic-portal/meta";
...
export const COMPONENT_DETAILS: Record<string, ComponentDetail> = {
  ...
  [gimbalStream.slug]: gimbalStream,
  [gravityCursor.slug]: gravityCursor,
  [hoverMediaStream.slug]: hoverMediaStream,
  [japparii.slug]: japparii,
  [kineticPortal.slug]: kineticPortal,
