...
export function Abyss3DLogoPiece({
  size = 220,
  className = "",
  style = {},
}: Abyss3DLogoPieceProps) {
  ...
  useEffect(() => {
    ...
    // --- Dynamic Camera-Mounted Key Lights ---
    ...
    // High-contrast Studio HDRI reflection dome
    ...
    const animate = (now: number) => {
      ...
      // Pure continuous 360-degree rotational cinematic loop
