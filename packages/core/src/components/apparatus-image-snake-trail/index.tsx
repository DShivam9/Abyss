...
import { ApparatusImageSnakeTrailProps } from "./types";

const MIXED_FOOD_POOL = [
  ...
  "/images/shapes/Shape 60.svg",
  "/images/components images/scroll/a3.webp",
  "/images/shapes/Shape 66.svg",
  "/images/components images/scroll/p1_hq.webp",
  "/images/shapes/Shape 70.svg",
];

const SVG_COLOR_FILTERS = [
  "invert(48%) sepia(90%) saturate(3500%) hue-rotate(120deg) brightness(135%)",
  "invert(50%) sepia(100%) saturate(3500%) hue-rotate(280deg) brightness(145%)",
  "invert(65%) sepia(100%) saturate(3000%) hue-rotate(170deg) brightness(135%)",
  "invert(75%) sepia(100%) saturate(4000%) hue-rotate(45deg) brightness(135%)",
  "invert(40%) sepia(100%) saturate(3500%) hue-rotate(240deg) brightness(145%)",
  "invert(55%) sepia(100%) saturate(4500%) hue-rotate(10deg) brightness(135%)",
];

const WORLD_CENTER = 6000;
const WRAP_SPAN = 6000;
